...
import com.cg.Lib.producer.Sender;

@RunWith(SpringRunner.class)
@SpringBootTest
@DirtiesContext
//@EmbeddedKafka(partitions = 1, topics = { SpringKafkaApplicationTest.HELLOWORLD_TOPIC })
public class SpringKafkaSenderApplicationTest {

	private static final Logger LOGGER = LoggerFactory.getLogger(SpringKafkaSenderApplicationTest.class);

	private static String SENDER_TOPIC = "helloworld.t";
