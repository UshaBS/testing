...
import com.cg.Lib.consumer.Receiver;

@RunWith(SpringRunner.class)
@SpringBootTest
@DirtiesContext
public class SpringKafkaReceiverApplicationTest {

	private static final Logger LOGGER = LoggerFactory.getLogger(SpringKafkaReceiverApplicationTest.class);

	private static String RECEIVER_TOPIC = "helloworld.t";
